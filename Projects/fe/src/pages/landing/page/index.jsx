                ...
                <div className="relative isolate px-6 pt-14 lg:px-8">
                    ...
                    <div className="mx-auto max-w-6xl py-32 sm:py-48 lg:py-56">
                        ...
                        <div className="text-center">
                            <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl" style={{ wordBreak: 'break-word', whiteSpace: 'normal', width: '100%' }}>
                                친구 목소리의 AI 캐릭터, 실시간 방송까지!
                            </h1>
                            <p className="mt-10 text-lg leading-8 text-gray-600" style={{ wordBreak: 'break-word', whiteSpace: 'normal' }}>
                                친구와 지인의 말투를 학습한 AI 챗봇과 1대1 대화를 나누고, 
                            </p>
                            <p className=" text-lg leading-8 text-gray-600" style={{ wordBreak: 'break-word', whiteSpace: 'normal' }}>
